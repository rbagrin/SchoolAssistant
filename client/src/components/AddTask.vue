    ...
    >
      ...
      <v-card>
        ...
        <v-card-text>
            ...
            <v-text-field v-model="title" name="task-title" :value="title" label="Task Title" :rules="[rules.required]"></v-text-field>
            <v-menu
                ref="menu"
                v-model="menu"
    ...
    methods: {
        saveTa2sk: function() {
            ...
            this.loading = true;
                ...
                this.$props.tasks.push({title: this.title, course: this.course, taskDescription: this.taskDescription, deadline: this.date})
